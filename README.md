...
Backend: Java (JDK 25) with built-in HTTP server
Database: MySQL 8.0
...
java/
├── src/
│ ├── Main.java # HTTP server & API handlers
│ ├── dao/UserDAO.java # Database operations
│ ├── model/User.java # User entity & GPA logic
│ ├── util/DBConnection.java # MySQL connection
│ └── utils/KaggleImporter.java
├── lib/ # JAR dependencies
├── css/style.css # Global styles
├── js/app-core.js # Shared utilities
├── *.html # Frontend pages
├── eduinsight.sql # Database schema
